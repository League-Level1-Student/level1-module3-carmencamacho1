...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Welcome! The secret location is on the tip of her thumb.");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		int secretLocationX = 75;
		int secretLocationY = 145;
		/**
	...
	String q = JOptionPane.showInputDialog("Ask any question to the Fortune teller.");
